    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-body">
                <form action="<?= base_url('purchasing/reject') ?>" class="form-horizontal" method="post" id="form-reject">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <form action="<?= base_url('purchasing/bulk_no_penyesuaian') ?>" method="post" id="form-bulk">
                ...
                <table class="table table-striped datatable" id="table-reject">
                    <thead>
                        <tr class="bg-navy">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="text-center">
                                <input type="checkbox" name="ids[]" value="<?= $reject['id_pengembalian'] ?>" class="check-item">
                            </td>
                            <td><?= $i++; ?></td>
...
<script>
    $(document).ready(function() {
        // --- SCRIPT BAWAAN ANDA ---
        var table = $('#table-reject').DataTable({
            "ordering": false, 
            "language": {
                "emptyTable": "Tidak ada data Reject"
            },
            "columnDefs": [
        ...
        // 3. Script Logic Pop Up dan Submit Bawaan Anda
        ...
        window.submitKirimGudang = function() {
            ...
            $('#form-bulk').attr('action', '<?= base_url("purchasing/kirim_gudang_reject") ?>');
            
            $('#form-bulk').append('<input type="hidden" name="no_penyesuaian_modal_val" value="'+no_penyesuaian+'">');
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="no_penyesuaian_modal" name="no_penyesuaian_modal" class="form-control" placeholder="Masukkan nomor penyesuaian">
                </div>
                <div class="form-group">
