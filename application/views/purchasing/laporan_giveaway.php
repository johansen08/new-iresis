    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-body">
                <form action="<?= base_url('purchasing/laporan-giveaway') ?>" class="form-horizontal" method="post" id="form-filter">
                    <div class="form-group">
                        <label class="col-md-3 col-xs-12 control-label">Rentang waktu Pengiriman</label>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">Laporan Barang Giveaway (Gudang Purchasing)</h3>
            </div>
            <div class="panel-body">
                <div class="table-responsive">
                    <table class="table table-striped table-hover datatable" id="table-giveaway-laporan">
                        <thead>
                            <tr class="bg-navy">
                                <th>No.</th>
                                <th>Tanggal Masuk</th>
...
$(document).ready(function() {
    $('#table-giveaway-laporan').DataTable({
        "ordering": false
    });
