<form action="report_production_team/export_to_excel_tab1" class="form-horizontal nojs" method="post" target="_blank">
...
<script type="text/javascript">
  ...
  $('#btn-search-receipt-process-tab1').on('click', function() {
    table_receipt_tab1 = $('#datatable-receipt-process-tab1').DataTable({
      ...
      'ajax': {
        url: 'report_production_team/get_data_receipt_tab1',
        type: 'POST',
        data: function(d) {
