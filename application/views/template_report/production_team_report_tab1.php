...
<h2 style="font-family: Calibri; color: #6e2f0a;">&#128203; LAPORAN PRODUKSI PACKER</h2>
...
<table style="border:none; margin-bottom: 10px;" class="no-border">
    ...
    <tr>
        ...
        <td style="border:none;">:</td>
        <td style="border:none; font-weight:bold; color:#6e2f0a;"><?= $grand_total ?></td>
    </tr>
    </tbody>
</table>
...
<table>
    <thead>
        <tr>
            <th colspan="11" class="header-inti">&#11088; PACKER INTI</th>
...
<table style="width: 500px;">
    <thead>
        <tr>
            <th class="summary-header" colspan="4">&#128202; RANGKUMAN PRODUKSI PACKER</th>
        </tr>
        <tr>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="summary-inti-val" style="color:#6e2f0a;"><?= $total_masuk_inti ?></td>
