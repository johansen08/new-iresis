...
$sections = [
    'ROLE PICKER (TIM INTI)' => $top_pickers_inti ?? [],
    'PERBANTUAN / NON INTI' => $top_pickers_others ?? [],
];
?>
    ...
    <div class="table-wrapper">
        <table>
            ...
            <?php if (!empty($rows)): ?>
                ...
                $totalSkuQty = $sumField($rows, 'total_qty');
                $totalEror = $sumField($rows, 'total_eror');
                $totalFinalSku = $sumField($rows, 'total_final_sku');
                ...
                <?php foreach ($rows as $row): ?>
                    ...
                    <tr>
                        ...
                        <td><?= $no ?></td>
                        <td><?= $row['total_qty'] ?></td>
                        <td><?= $row['total_eror'] ?></td>
                        <td><?= $row['total_final_sku'] ?></td>
                        <td><?= $formatPercent($row['total_final_sku'], $totalFinalSku) ?></td>
                        <td><?= $rankSku++ ?></td>
                        <td><?= $row['total_qty'] ?></td>
                        <td><?= $formatPercent($row['total_qty'], $totalSkuQty) ?></td>
                        <td><?= $rankQty++ ?></td>
