...
<script type="text/javascript">
    ...
    $('#btn-search-production-team-tab0').on('click', function() {
        ...
        $('#datatable-production-team-tab0 tbody').on('dblclick', 'tr.group', function () {
            var currentOrder = table_production_team_tab0.order()[0];
            if (currentOrder[0] === groupColumn && currentOrder[1] === 'asc') {
                table_production_team_tab0.order([groupColumn, 'desc']).draw();
            }
            else {
                table_production_team_tab0.order([groupColumn, 'asc']).draw();
            }
        });
    });
</script>