  ...
  <div class="col-md-12">
    <div class="panel panel-default">
      <div class="panel-heading">
        <h3 class="panel-title"><strong>Laporan Masalah Picker</strong></h3>
      </div>

      <div class="panel-body">
        <form action="restock/laporan-masalah-picker" class="form-horizontal" method="post" id="form-laporan-masalah-picker">
        ...
        <div class="table-responsive">
          <table class="table table-striped table-bordered" id="datatable-laporan-masalah-picker" style="width:100%">
            <thead>
              <tr>
                <th>Picker</th>
...
<style>
  #datatable-laporan-masalah-picker {
    font-size: 13px;
  }

  #datatable-laporan-masalah-picker thead th {
  ...
  #datatable-laporan-masalah-picker tbody td {
    vertical-align: middle;
  }

  #datatable-laporan-masalah-picker tr:hover {
...
<script>
  ...
  var table = $('#datatable-laporan-masalah-picker').DataTable({
    'scrollX': true,
    'pageLength': 25,
    'processing': true,
    'language': {
    ...
    'ajax': {
      url: 'restock/get-laporan-masalah-picker-data',
      type: 'POST',
      data: function (d) {
  ...
  $('#btn-export-excel').on('click', function () {
    ...
    var url = 'restock/export-laporan-masalah-picker?reportrange=' + encodeURIComponent(reportrange);
  ...
  $('#datatable-laporan-masalah-picker').on('click', '.btn-hapus', function () {
    var id = $(this).data('id');
  ...
  $('#datatable-laporan-masalah-picker').on('click', '.btn-kembalikan', function () {
    var id = $(this).data('id');
