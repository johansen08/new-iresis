<form action="report_receipt_process/export_to_excel_tab0" class="form-horizontal nojs" method="post" target="_blank">
...
<script type="text/javascript">
  ...
  $('#btn-search-receipt-process-tab0').on('click', function() {
    table_receipt_process_tab0 = $('#datatable-receipt-process-tab0').DataTable({
      ...
      'ajax': {
        url: 'report_receipt_process/get_data_receipt_process_tab0',
        type: 'POST',
        data: function(d) {
