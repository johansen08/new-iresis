    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-body">
                <form action="<?= base_url('inbound/riwayat-surat-jalan') ?>" class="form-horizontal" method="post"
                    id="form-riwayat-surat-jalan">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <form action="<?= base_url('inbound/update_status_surat_jalan') ?>" method="post" id="form-bulk">
                    ...
                    <table class="table table-striped datatable">
                        ...
                        <tbody>
                            <?php $i = 1; foreach ($list_surat_jalan as $surat_jalan): ?>
                            <tr>
                                <td class="text-center">
                                    <input type="checkbox" name="ids[]" value="<?= $surat_jalan['id'] ?>"
                                        class="check-item">
                                </td>
                                <td><?= $i++; ?></td>
                                <td><?= $surat_jalan['created_at'] ?></td>
                                <td><?= $surat_jalan['nama_file'] ?></td>
                                <td class="text-center">
                                    <?php if(!empty($surat_jalan['link_dokumen'])): ?>
                                    <a href="<?= $surat_jalan['link_dokumen'] ?>" target="_blank"
                                ...
                                <td class="text-center"><?= $surat_jalan['jenis'] ?? '-' ?></td>
                                <td class="text-center">
                                    <?= !empty($surat_jalan['status_inbound']) ? $surat_jalan['status_inbound'] : '-' ?>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
...
$(document).ready(function() {
    var table = $('#table-riwayat-surat-jalan').DataTable({
        "ordering": false,
        "language": {
