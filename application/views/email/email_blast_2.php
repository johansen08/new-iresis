...
<head>
	...
	*/
        ...
        #templateHeader {
            ...
            /*@editable*/
            /* background-image: url(https://cdn-images.mailchimp.com/template_images/gallery/bike3.jpeg); */
            background-image: url(<?= $this->config->item("app_mainsite_url").'uploads/email_blast/'.$email_blast['image'] ?>);
            /*@editable*/
            background-repeat: no-repeat;
            /*@editable*/
            background-position: center;
