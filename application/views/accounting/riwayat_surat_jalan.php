    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <form action="<?= base_url('accounting/riwayat_surat_jalan') ?>" class="form-horizontal" method="post" id="form-riwayat-surat-jalan">
                ...
                <div class="panel-body">
                    <div class="table-responsive">
                        <table class="table table-striped datatable" id="table-returan">
                            ...
                            <tbody>
                                <?php if(!empty($list_riwayat_surat_jalan)): ?>
                                    <?php $i = 1; foreach ($list_riwayat_surat_jalan as $riwayat_surat_jalan): ?>
                                    <tr>
                                        <td><?= $i++; ?></td>
                                        <td><?= $riwayat_surat_jalan['nama_file'] ?></td>
                                        <td class="text-center">
                                            <?php if(!empty($riwayat_surat_jalan['link_dokumen'])): ?>
                                                <a href="<?= $riwayat_surat_jalan['link_dokumen'] ?>" target="_blank" class="btn btn-primary btn-xs">
                                        ...
                                        <td><?= $riwayat_surat_jalan['jenis'] ?></td>
                                        <td><?= $riwayat_surat_jalan['nama_pegawai'] ?></td>
                                        <td><?= $riwayat_surat_jalan['created_at'] ?></td>
                                        <td class="text-center" style="white-space: nowrap;">
                                            <a href="javascript:void(0);" 
                                                class="btn btn-warning btn-xs btn-edit-surat-jalan"
                                                data-id="<?= $riwayat_surat_jalan['id'] ?>"
                                                data-namafile="<?= $riwayat_surat_jalan['nama_file'] ?>"
                                                data-linkdokumen="<?= $riwayat_surat_jalan['link_dokumen'] ?>"
                                                data-jenis="<?= $riwayat_surat_jalan['jenis'] ?>"
                                            ...
                                            <button type="button" 
                                                    ...
                                                    data-url="<?= base_url('accounting/delete-surat-jalan/'.$riwayat_surat_jalan['id']) ?>" 
                                                    title="Delete">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="modalLabel">Edit Surat Jalan</h4>
            </div>
            
            <form action="<?= base_url('accounting/update-surat-jalan') ?>" method="POST">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="jenis" id="edit_jenis" required>
                            ...
                            <option value="TIM RESI">TIM RESI</option>
                            <option value="TOP LEVEL">TOP LEVEL</option>
                            <option value="TIM ACCOUNTING">TIM ACCOUNTING</option>
                        </select>
                    </div>
                </div>
...
$(document).ready(function() {
    ...
    $('#reportrange').on('apply.daterangepicker', function (ev, picker) {
        ...
        $('#form-riwayat-surat-jalan').submit(); 
    });
    ...
    $(document).on('click', '.btn-edit-surat-jalan', function() {
        var id = $(this).data('id');
