  ...
  <div class="col-md-12">
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="accounting/laporan-kurangan-picker" class="form-horizontal" method="post" id="form-laporan-kurangan-picker">
...
<script>
  ...
  var table = $('#datatable-laporan-kurangan-picker').DataTable({
    ...
    'ajax': {
      url: 'accounting/get-laporan-kurangan-picker-data',
      type: 'POST',
      data: function(d) {
  ...
  function processActionKurangan(formId, modalId) {
      ...
      $form.on('submit', function(e) {
          ...
          $.ajax({
              url: 'accounting/action-kurangan-picker',
              method: 'POST',
              data: $form.serialize(),
              dataType: 'json',
  ...
  $('#btn-search').on('click', function() {
    ...
    $('#form-laporan-kurangan-picker').attr('action', 'accounting/laporan-kurangan-picker');
  });
  
  $('#btn-export-excel').on('click', function() {
    $('#form-laporan-kurangan-picker').attr("target", "_blank");
    $('#form-laporan-kurangan-picker').addClass('nojs');
    $('#form-laporan-kurangan-picker').attr('action', 'accounting/export-excel-laporan-kurangan-picker');
  });
</script>
