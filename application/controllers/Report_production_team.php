...
class Report_production_team extends MY_Controller
{
  ...
  public function export_to_excel_tab0()
  {
    ...
    $this->load->view('report_production_team_export_to_excel_tab0', $data);
  }
  ...
  public function export_to_excel_tab1()
  {
    ...
    $this->load->view('report_production_team_export_to_excel_tab1', $data);
  }
}
